...
class ResearcherAgent:
    def __init__(self):
        self.directory_tool = DirectoryReadTool(directory='knowledge_files/')
    ...
    def get_tasks(self):
        return [
            {
                "description": dedent("""
                    Analyze the knowledge files in the knowledge_files directory to extract key themes and concepts for each of the 7 periods 
                    of the 7 Cycles system. Use the DirectoryReadTool to explore the directory and FileReadTool to read individual files.
                    
                    Focus on:
                    1. Use DirectoryReadTool to list all files in the knowledge_files directory
